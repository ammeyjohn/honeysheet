...
import mMenu from 'metronic/js/framework/components/general/menu'
import mScrollTop from 'metronic/js/framework/components/general/scroll-top'
import mToggle from 'metronic/js/framework/components/general/toggle'
